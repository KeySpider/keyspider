...
class TestSalesForceViaSCIM extends TestCase
{
    ...
    {
        $dataUpdated = ['externalSFID' => '00G2v0000033KZzEAM', 'GroupName' => 'Hehe'];
        $result = ($this->scimLib->updateResource('Group', $dataUpdated));
        $this->assertEquals($result, 204);

    }

    public function testEditUser()
    {
        $dataUpdated = ['externalSFID' => '0052v00000gcFwLAAU',
            "LastName" => "Tuan",
            "FirstName" => "Le",
        ...
        $result = $this->scimLib->updateResource('User', $dataUpdated);
        $this->assertEquals($result, 204);
    }
