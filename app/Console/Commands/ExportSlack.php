...
class ExportSlack extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = "command:export_slack";
    ...
    public function handle()
    {
        ...
        if (array_key_exists(Consts::SLACK_EXTRACT_PROCESS_CONFIGURATION, $keyspider)) {
            // Setup schedule for Extract
            $extractSettingManager = new ExtractSettingsManager(Consts::SLACK_EXTRACT_PROCESS_CONFIGURATION);
    ...
    public function exportDataForTimeExecution($settings)
    {
        foreach ($settings as $dataSchedule) {
            ...
            $extractor->processExtractToSlack();
        }
    }
}
